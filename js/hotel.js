$(function() {
    ...
    $('.icon_datepicker').datepicker({
        ...
        ,buttonImage: "/image/sub/calendar.png" //버튼 이미지 경로
    ...
    $('.icon_datepicker, .ipt_datepicker').datepicker('setDate', 'today'); //(-1D:하루전, -1M:한달전, -1Y:일년전), (+1D:하루후, -1M:한달후, -1Y:일년후)            
